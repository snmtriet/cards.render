...
export const CardsLoading = (props: CardsRenderProps) => {
  const { style, cardOffset } = props;
          ...
          <div className="card__info">
            <div className="card__title">
              <div className="card__titleTop">
                <span
                  className="card__collection isLoading"
                  style={{ minWidth: 160, height: 15, borderRadius: 4 }}
                ></span>
                <div
                  className="isLoading"
                  style={{ minWidth: 15, height: 15, borderRadius: 4 }}
                ></div>
              </div>
              <span
                className="card__nft isLoading"
                style={{
                  minWidth: 15,
                  height: 15,
                  borderRadius: 4,
